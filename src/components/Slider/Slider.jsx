...
export const Slider = ({rare}: SliderType) => {
    ...
    const onNext = () => value === 3 ? setValue(0) : setValue(value + 1);
    const onPrev = () => value === 0 ? setValue(3) : setValue(value - 1)
        ...
        <div className={styles.wrapper}>
            <div className={styles.container}>
                ...
                <div className={styles.titles}>
                    <h4 onClick={onPrev}>{data[value === 0 ? 3 : value-1].name}</h4>
                    <h4 className={styles.titleCenter}>{data[value].name}</h4>
                    <h4 onClick={onNext}>{data[value === 3 ? 0 : value+1].name}</h4>
                </div>
            </div>
            <div className={styles.nav}>
                <button className={styles.prev} type="button" onClick={onPrev}>
